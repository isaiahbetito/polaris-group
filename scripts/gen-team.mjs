...
const members = [
  { slug:'cristina', initials:'C', name:'Cristina Milanesi', xptype:'operations',
    ...
    bio:{it:'Da un anno parte del team Polaris, si occupa della gestione dei piani e delle attività di front e back office: organizzazione delle pratiche, coordinamento delle attività operative e assistenza ai clienti. Svolge il proprio ruolo con professionalità, precisione e spirito di collaborazione, garantendo un servizio efficiente e attento alle esigenze di ogni interlocutore.',en:'A member of the Polaris team for the past year, she manages plans and front- and back-office activities: organising paperwork, coordinating operations and assisting clients. She carries out her role with professionalism, precision and a collaborative spirit, ensuring an efficient service attentive to every client’s needs.'},
  ...
  { slug:'alessio', initials:'A', name:'Alessio Di Cesare', xptype:'amministrazione',
    ...
    bio:{it:'In Polaris dal 2020, ricopre il ruolo di responsabile amministrativo: cura la tenuta della contabilità, in collaborazione con il collega Gianmaria, la fatturazione e la gestione dei pagamenti. Coltiva inoltre un vivo interesse per la lettura, la musica e il cinema.',en:'With Polaris since 2020, he serves as head of administration, overseeing bookkeeping, in collaboration with his colleague Gianmaria, together with invoicing and payment management. He also has a keen interest in reading, music and cinema.'},
    company:{it:'Polaris Group',en:'Polaris Group'},
  ...
  { slug:'mara', initials:'M', name:'Mara Carioni', xptype:'sumisura',
    ...
    bio:{it:'Entrata in Polaris nel 2015, al termine del proprio percorso di studi, è cresciuta professionalmente all’interno dell’azienda fino ad assumere la responsabilità dell’Area Formazione, che coordina la progettazione, la gestione e la rendicontazione dei progetti formativi.',en:'She joined Polaris in 2015, upon completing her studies, and has grown professionally within the company to take on responsibility for the Training area, coordinating the design, delivery and reporting of training projects.'},
    company:{it:'Polaris Group',en:'Polaris Group'},
  ...
  { slug:'paola', initials:'P', name:'Paola Franzoni', xptype:'formazione',
    ...
    bio:{it:'Professionista della formazione e delle risorse umane, vanta una consolidata esperienza nella progettazione e nella gestione di percorsi formativi finanziati e aziendali. Da oltre sei anni, con Polaris HR, affianca imprese e lavoratori nello sviluppo delle competenze, nella formazione sulla sicurezza e nella valorizzazione del capitale umano. Il suo approccio unisce competenza tecnica, ascolto delle esigenze aziendali e orientamento ai risultati, con l’obiettivo di costruire percorsi di crescita concreti e sostenibili.',en:'A training and human-resources professional, she brings established experience in the design and management of funded and corporate training programmes. For over six years, with Polaris HR, she has supported companies and employees in developing skills, in workplace-safety training and in enhancing human capital. Her approach combines technical expertise, attentiveness to business needs and a focus on results, with the aim of building concrete and sustainable growth paths.'},
    company:{it:'Polaris Group',en:'Polaris Group'},
  ...
  { slug:'andrea', initials:'A', name:'Andrea Ungaro', xptype:'formazione',
    ...
    bio:{it:'Giovane collaboratore dell’Area Formazione, nato nel 2005, supporta la gestione dei piani formativi con impegno e spirito di collaborazione. Affronta ogni attività con serietà, ordine e senso di responsabilità.',en:'A young collaborator in the Training area, born in 2005, he supports the management of training plans with commitment and a collaborative spirit. He approaches every task with seriousness, order and a sense of responsibility.'},
    company:{it:'Polaris Group',en:'Polaris Group'},
  ...
  { slug:'roberta', initials:'R', name:'Roberta Tagliani', xptype:'formazione',
    ...
    bio:{it:'Consulente e libera professionista, è esperta nella progettazione e nella gestione dei processi formativi, con specializzazione in Salute e Sicurezza sul Lavoro (RSPP) e Igiene degli Alimenti (HACCP). Laureata in Scienze della Formazione presso l’Università di Verona e con oltre quindici anni di esperienza sul campo, affianca le aziende nella tutela dei lavoratori, nella regolarizzazione dei processi interni e nella crescita delle risorse umane. Ha collaborato stabilmente con enti di formazione, associazioni di categoria e imprese, occupandosi di docenze specialistiche, incarichi di RSPP e igiene degli alimenti, accreditamento regionale e sistemi di gestione della Qualità e della Privacy (GDPR). Un ambito centrale della sua attività è l’accompagnamento delle imprese nell’accesso ai fondi interprofessionali e ai bandi regionali e camerali, nella convinzione che la formazione non sia un adempimento burocratico, bensì un investimento per prevenire i rischi e migliorare l’efficienza aziendale.',en:'A consultant and freelance professional, she is an expert in the design and management of training processes, specialising in Workplace Health & Safety (RSPP) and Food Hygiene (HACCP). A graduate in Education Sciences from the University of Verona, with over fifteen years of field experience, she supports companies in protecting their workers, regularising internal processes and developing their people. She has collaborated on a lasting basis with training bodies, trade associations and companies, undertaking specialist teaching, external RSPP and food-hygiene assignments, regional accreditation and Quality and Privacy (GDPR) management systems. A central focus of her work is supporting companies in accessing interprofessional funds and regional and chamber grants, in the conviction that training is not a bureaucratic obligation but an investment to prevent risks and improve business efficiency.'},
    company:{it:'Polaris Group',en:'Polaris Group'},
...
<style>
  ...
  .bio-photo__mono{width:100%;height:100%;display:flex;align-items:center;justify-content:center;
    font-family:var(--serif);font-size:9rem;font-weight:500;color:#fff;
  ...
  .bio-summary{font-size:18px;color:#fff;line-height:1.8;margin-top:28px;max-width:560px}
  .bio-meta{display:flex;flex-wrap:wrap;gap:36px;margin-top:34px;padding-top:28px;border-top:1px solid rgba(184,194,204,.16)}
  .bio-meta__label{display:block;font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:#fff;margin-bottom:5px}
  .bio-meta__value{font-size:14px;font-weight:500;color:#fff}
  ...
  .xp-head p{margin-top:18px;font-size:1.05rem;color:#fff;line-height:1.7;text-shadow:0 1px 12px rgba(8,14,22,.55)}
  ...
  .xp-card__d{font-size:.95rem;color:#fff;line-height:1.7}
  ...
  .belief__by{margin-top:28px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;color:#fff;font-weight:600}
  ...
  <section class="section section--cream reveal">
    <div class="container">
      <div style="max-width:720px;margin:0 auto;text-align:center">
        <h2 style="font-family:var(--serif);font-weight:500;font-size:clamp(2.2rem,4.6vw,3.4rem);color:var(--navy-deep);line-height:1.1;letter-spacing:-.012em;margin:0" data-it-html="Chi <em style='font-style:italic;color:var(--steel)'>Sono</em>" data-en-html="About <em style='font-style:italic;color:var(--steel)'>Me</em>">Chi <em style="font-style:italic;color:var(--steel)">Sono</em></h2>
